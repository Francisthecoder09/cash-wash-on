...
INSERT IGNORE INTO branches (id, name, location, timezone, active, created_at, updated_at) VALUES
...
INSERT IGNORE INTO lanes (id, branch_id, lane_name, display_order, active, created_at, updated_at) VALUES
...
INSERT IGNORE INTO staff (id, branch_id, full_name, employee_code, phone, active, created_at, updated_at) VALUES
...
INSERT IGNORE INTO customers (id, full_name, phone, email, total_visits, loyalty_points, last_vehicle_registration, created_at, updated_at) VALUES
...
INSERT IGNORE INTO users (id, branch_id, staff_id, email, username, password_hash, pin_hash, role, active, created_at, updated_at) VALUES
...
INSERT IGNORE INTO vehicle_sessions (
...
INSERT IGNORE INTO mats_tracking (id, vehicle_session_id, mats_removed, mats_reinstalled, condition_notes, created_at, updated_at) VALUES
...
INSERT IGNORE INTO signatures (id, vehicle_session_id, signed_by, signature_data_url, created_at, updated_at) VALUES
(1, 1, 'Nana Kwarteng', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAB', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT IGNORE INTO inspections (id, vehicle_session_id, inspector_staff_id, body_check_passed, interior_check_passed, notes, created_at, updated_at) VALUES
...
INSERT IGNORE INTO audit_logs (id, user_id, vehicle_session_id, action, description, metadata_json, created_at, updated_at) VALUES
...
INSERT IGNORE INTO service_types (id, service_name, description, base_price, duration_minutes, category, is_featured, active, created_at, updated_at) VALUES
...
INSERT IGNORE INTO pricing (id, service_type_id, vehicle_category, price, discount_percentage, active, created_at, updated_at) VALUES
